...
<html lang="en">
<head>
    <title>Code coverage report for gingerbread/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">gingerbread/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">gingerbread/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (i &lt;= suggestion.From) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (suggestion.From !== 0) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (i &lt; text.length) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Feb 12 2015 16:41:57 GMT+0100 (CET)</div>
</div>
